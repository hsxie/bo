...
savepath='../output/ringbeam_Umeda12/'; % choose where to save the figures and outputs
iem=1; % =1, electromagnetic run; =0, electrostatic run; =2, Darwin model

N=8; % Number harmonics, enlarge N to make sure the results are convergent
...
par(2)=40.0; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=0.01; pa2=0.3; dpa=0.0025; % 1st parameter a, depends on ipa
