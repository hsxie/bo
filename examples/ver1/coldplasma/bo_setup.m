...
savepath='../output/coldplasma/'; % choose where to save the figures and outputs
...
B0=100.0E-9; % magnetic field (Tesla)

% initialize the parameters k, theta, kz, kx
par=zeros(6,1);
par(1)=0.5; % k, =sqrt(kx^2+kz^2), normalized by kn
par(2)=60.0; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=0.01; pa2=0.99e2; dpa=0.05e1; % 1st parameter a, depends on ipa
