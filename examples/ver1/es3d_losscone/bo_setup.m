...
savepath='../output/es3d_losscone/'; % choose where to save the figures and outputs
iem=0; % =1, electromagnetic run; =0, electrostatic run; =2, Darwin model
...
par(2)=88.5; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=0.1; pa2=2.0; dpa=0.01; % 1st parameter a, depends on ipa
