...
savepath='../output/perpbeam/'; % choose where to save the figures and outputs
...
B0=7.0E-9; % magnetic field (Tesla)
...
ilogb=0;
pa1=0.1; pa2=10.0; dpa=0.2; % 1st parameter a, depends on ipa
