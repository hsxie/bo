...
savepath='../output/Darwin/'; % choose where to save the figures and outputs
iem=2; % =1, electromagnetic run; =0, electrostatic run; =2, Darwin model
...
B0=82.47E-7; % magnetic field (Tesla)

% initialize the parameters k, theta, kz, kx
par=zeros(6,1);
par(1)=0.0; % k, =sqrt(kx^2+kz^2), normalized by kn
...
ilogb=0;
pa1=0.01; pa2=2.5; dpa=0.01; % 1st parameter a, depends on ipa
