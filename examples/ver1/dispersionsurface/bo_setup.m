...
savepath='../output/dispersionsurface/'; % choose where to save the figures and outputs
...
B0=5.0E-9; % magnetic field (Tesla)

% initialize the parameters k, theta, kz, kx
par=zeros(6,1);
par(1)=0.5; % k, =sqrt(kx^2+kz^2), normalized by kn
par(2)=45.0; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=0.01e1; pa2=1.0e2; dpa=0.2e1; % 1st parameter a, depends on ipa
% pa2=-0.01; pa1=-2.5; dpa=0.01; % 1st parameter a, depends on ipa
% pa1=1; pa2=89; dpa=2.5; % 1st parameter a, depends on ipa
pb1=0.0; pb2=90.0; dpb=5.0; % 2nd parameter b, depends on ipb
