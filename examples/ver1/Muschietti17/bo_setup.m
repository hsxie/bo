...
savepath='../output/Muschietti17/'; % choose where to save the figures and outputs
...
B0=1.0; % magnetic field (Tesla)

% initialize the parameters k, theta, kz, kx
par=zeros(6,1);
par(1)=10.0; % k, =sqrt(kx^2+kz^2), normalized by kn
par(2)=50.0; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=10.0; pa2=75; dpa=0.5; % 1st parameter a, depends on ipa
