...
savepath='../output/cmp_iem13_coldbeam/'; % choose where to save the figures and outputs
...
B0=2.0E-6; % magnetic field (Tesla)

% initialize the parameters k, theta, kz, kx
par=zeros(6,1);
par(1)=0.5; % k, =sqrt(kx^2+kz^2), normalized by kn
par(2)=10.0; % theta, the angle between k and B0, normalized by *pi/180
...
ilogb=0;
pa1=0.05; pa2=5.0; dpa=0.025; % 1st parameter a, depends on ipa
