...
close all;
h=figure('unit','normalized','Position',[0.01 0.05 0.8 0.85],...
  'DefaultAxesFontSize',14);

jpl=1;
pkzz=Pola(:,:,jpl,npolaf-2)/kn;
s=1;
% jjpola=[npolaf,1,2,3,npolaf+1,npolaf+2,npolaf+3,(npolaf+3+7*(s-1)+1):(npolaf+3+7*s)];

% jjpola=[npolaf,(npolaf+3+7*(s-1)+5):(npolaf+3+7*s-1),...
%     (npolaf+3+7*(2-1)+5):(npolaf+3+7*2-1),(npolaf+3+7*(3-1)+5):(npolaf+3+7*3-1),...
%     (npolaf+3+7*(4-1)+5):(npolaf+3+7*4-1)];
jjpola=[npolaf,(npolaf+3+npolas*0+4):(npolaf+3+npolas*0+7),...
    (npolaf+3+npolas*1+4):(npolaf+3+npolas*1+7),...
    (npolaf+3+npolas*2+4):(npolaf+3+npolas*2+7),...
    (npolaf+3+npolas*3+4):(npolaf+3+npolas*3+7),...
    1:3];
...
%       plot(pkzz,real(Pola(:,:,jpl,jjpola(jj))./Pola(:,:,jpl,(npolaf+3+7*(1-1)+5))),...
%         pkzz,imag(Pola(:,:,jpl,jjpola(jj))./Pola(:,:,jpl,(npolaf+3+7*(1-1)+5))),'--','linewidth',2);
...
hleg=legend('BO Re','BO Im','WHAMP Re','WHAMP Im','location','southeast');
legend('boxoff');
